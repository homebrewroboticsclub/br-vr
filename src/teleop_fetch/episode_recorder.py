...
from teleop_fetch.correlation_metadata import (
    merge_data_node_correlation_metadata,
    merge_recovery_training_metadata,
)
...
class EpisodeRecorder:
    ...
    def _write_robot_side(self) -> None:
        ...
        merge_recovery_training_metadata(metadata, len(self._operator_frames), len(self._robot_frames))
    ...
    def attach_upload_record(
        ...
        merge_data_node_correlation_metadata(metadata, self.dataset_id)
        merge_recovery_training_metadata(metadata, len(operator_frames), len(self._robot_frames))
